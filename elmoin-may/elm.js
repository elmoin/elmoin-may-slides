...
Elm.Slides.make = function (_elm) {
   ...
   var goBack = function (_p0) {
      ...
      var _p2 = _p5;
      if (_p2.ctor === "[]") {
            return {ctor: "_Tuple3",_0: _p5,_1: _p3,_2: _p4};
         } else {
            return {ctor: "_Tuple3"
                   ,_0: _p2._1
                   ,_1: _p2._0
                   ,_2: A2($List._op["::"],_p3,_p4)};
         }
   };
   var goForward = function (_p6) {
      var _p7 = _p6;
      var _p11 = _p7._0;
      var _p10 = _p7._2;
      var _p9 = _p7._1;
      var _p8 = _p10;
      if (_p8.ctor === "[]") {
            return {ctor: "_Tuple3",_0: _p11,_1: _p9,_2: _p10};
         } else {
            return {ctor: "_Tuple3"
                   ,_0: A2($List._op["::"],_p9,_p11)
                   ,_1: _p8._0
                   ,_2: _p8._1};
         }
   };
   var update = F2(function (direction,model) {
      var _p12 = direction;
      switch (_p12.ctor)
      {case "Right": return goForward(model);
         case "Left": return goBack(model);
   ...
   var options = {githubFlavored: $Maybe.Just({tables: false
                                              ,breaks: false})
   ...
   var view = function (_p14) {
      var _p15 = _p14;
      return A2($Markdown.toHtmlWith,options,_p15._1);
   };
   var Stay = {ctor: "Stay"};
   var Right = {ctor: "Right"};
   var Left = {ctor: "Left"};
   var keyToDirection = function (_p16) {
      var _p17 = _p16;
      var _p19 = _p17.y;
      var _p18 = _p17.x;
      return _U.eq(_p18,1) || _U.eq(_p19,1) ? Right : _U.eq(_p18,
      -1) || _U.eq(_p19,-1) ? Left : Stay;
   };
   var state = function (initialSlides) {
      return A3($Signal.foldp,
      update,
      initialSlides,
      A2($Signal.map,keyToDirection,$Keyboard.arrows));
   };
   var start = function (initialSlides) {
      return A2($Signal.map,view,state(initialSlides));
   };
...
Elm.Elmoin = Elm.Elmoin || {};
Elm.Elmoin.make = function (_elm) {
   "use strict";
   _elm.Elmoin = _elm.Elmoin || {};
   if (_elm.Elmoin.values) return _elm.Elmoin.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var main = $Slides.start($Slides.fromList(A2($String.split,
   "\n\n\n",
   mySlides)));
   return _elm.Elmoin.values = {_op: _op
                               ,main: main
                               ,mySlides: mySlides};
};
